...
const BOOKSHOP_URL = "https://bookshop.org/lists/canIaffordahouse";
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 mt-12">
      <div className="grid md:grid-cols-3 gap-4">
        <a href={KOFI_URL} target="_blank" rel="noopener" className="card !block no-underline hover:border-[var(--accent)] transition">
        ...
        <a href={BOOKSHOP_URL} target="_blank" rel="noopener" className="card !block no-underline hover:border-[var(--accent)] transition">
          <div className="text-[var(--accent)] text-xs uppercase tracking-wider font-semibold mb-1">
        ...
        <div className="card">
          ...
          <div className="flex flex-col gap-1 text-sm">
            ...
            <a href="https://mycarbonfootprint.org" target="_blank" rel="noopener">
              {t.cta.sister.mycarbonfootprint} ↗
            </a>
          </div>
        </div>
      </div>
