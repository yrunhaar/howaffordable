...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const localizedDefaultPaths: ReadonlyArray<{
    ...
    { path: "/decades", priority: 0.85, changeFrequency: "monthly" },
    { path: "/rent-vs-buy", priority: 0.85, changeFrequency: "monthly" },
    { path: "/cities", priority: 0.85, changeFrequency: "monthly" },
    { path: "/mortgage-types", priority: 0.85, changeFrequency: "monthly" },
