import { COUNTRIES, type CountryCode, isCountryCode } from "@/data/housing-data";
...
export const SITE_URL = "https://howaffordable.org";
export const SITE_NAME = "How Affordable?";
